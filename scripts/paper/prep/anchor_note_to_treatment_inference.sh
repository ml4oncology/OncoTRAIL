...
data_path="${DATA_BASE_DIR}/processed/clinical_notes/data_pull_2025-01-08/splits/deid_merged_processed_cleaned_clinical_notes_medonc_only_epic_records_only.parquet.gzip"
treatment_data_path="${DATA_BASE_DIR}/final/data_2025-03-29/processed/treatment_centered_data.parquet"
...
opis_data_path="${DATA_BASE_DIR}/final/data_2025-03-29/interim/chemo.parquet"
test_end_date=None
lookback_window=30
...
treatment_dates_path="${DATA_BASE_DIR}/final/data_2025-03-29/processed/treatment_centered_dates.parquet"
