...
train_test_anchored_df_path="/cluster/projects/gliugroup/work_dir/wayne_uy/gitrepo/2024/OncoTRAIL/paper/pmh_method/data/train_test/note_anchored/note_anchored_firstTreatmentOnly-medOnc-ConsultLetterClinic_deid.csv"
...
save_dir="/cluster/projects/gliugroup/work_dir/wayne_uy/gitrepo/2024/OncoTRAIL/paper/pmh_method/data/inference/note_anchored"
...
save_dir="/cluster/projects/gliugroup/work_dir/wayne_uy/gitrepo/2024/OncoTRAIL/paper/pmh_method/data/inference/note_tabular_anchored"
for config_name in "firstTreatmentOnly-medOnc-ConsultLetterClinic_deid"; do
    ../../pySLURMargs.py $userName $memory $condaEnv $nGPU $runTime "../../../src/prep/anchor_note_to_treatment.py $mode $data_path $treatment_data_path $opis_data_path $save_dir $config_name $test_end_date $lookback_window $add_tabular_to_note --treatment_dates_path $treatment_dates_path --train_test_anchored_df_path $train_test_anchored_df_path" 
done