...
dataDir=${rootDir}/data/interim_deid_keepNL
saveDir=${rootDir}/data/embedding_deid_keepNL
suffix='deid'
...
do 
    ...
    do
        ...
        pySLURMargs.py $userName $memory $condaEnv $nGPU $runTime "../src/mergeEmbedding.py $dataDir $dataFileName $saveDir $numFiles --suffix $suffix"
