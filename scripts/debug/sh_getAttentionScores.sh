...
#     #     pySLURMargs.py $userName $memory $condaEnv $nGPU $runTime "../src/getAttentionScores.py $dataPath $LLMpath $LLMName $saveDir" 
...
dataDir=${rootDirProj}/data/attention_score
saveDir=${rootDirProj}/data/attention_score
LLMpath=${rootDirLLM}/Mistral-7B-v0.1
LLMName='Mistral'

#dataPath=${dataDir}/example_note.csv
dataPath=${dataDir}/example_note_stripped.csv
pySLURMargs.py $userName $memory $condaEnv $nGPU $runTime "../src/getAttentionScores.py $dataPath $LLMpath $LLMName $saveDir" 
