...
#saveDir=${rootDir}/data/interim_deid_prompting
dataDir=${rootDir}/data/interim_deid_nonmedical_prompting
saveDir=${rootDir}/data/interim_deid_nonmedical_prompting
suffix='deid'
