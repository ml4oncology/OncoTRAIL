...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "embed_data_dir", help="data directory", type=str
    )  # data directory
    parser.add_argument(
    ...
    parser.add_argument(
        "notes_fname", help="file name of notes", type=str
    )  # file name of notes
    args = parser.parse_args()

    addTargetToEmbedding(
        args.embed_data_dir, args.data_file_name, args.notes_path, args.notes_fname
    )
