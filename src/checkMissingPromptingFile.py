...
def checkMissingPromptingFile(data_dir, file_name, file_part_min, file_part_max, llm_name, target_name, suffix=''):
    """
...
if __name__ == "__main__":
    ...
    checkMissingPromptingFile(args.data_dir, args.file_name, args.file_part_min, args.file_part_max, args.llm_name, args.target_name, args.suffix)