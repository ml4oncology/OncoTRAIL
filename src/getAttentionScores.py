...
def getAttentionScores(data_path, LLM_path, LLM_name, save_dir):
    # extract file name
    ...
    def decoder_text_to_attention(text):
    ...
    if LLM_name in ["Mistral", "BioMistral", "Llama3-8B", "Llama3-8B-Instruct"]:
        ...
        text_to_attention = longformer_text_to_attention
    else:
...
if __name__ == "__main__":
    ...
    getAttentionScores(args.data_path, args.LLM_path, args.LLM_name, args.save_dir)
