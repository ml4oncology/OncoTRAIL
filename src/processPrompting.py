...
def gen_prompt(target_string):
    ...
    base_prompt = (
        ...
        + additional_info
        + " Provide a numerical value only as a response to 'Probability:'. Subsequently, concisely explain how you arrived at your answer as a response to 'Reason:'."
    )
...
def extract_probability(prompt_response):
    ...
    # find first \n:
    nl_idx = prompt_response.index("\n")

    # convert string to float
    prob_value = float(prompt_response[prob_idx:nl_idx].strip())
...
if __name__ == "__main__":
    ...
    process_prompting(
        args.data_path, args.LLM_path, args.LLM_name, args.save_dir, args.target_name
    )
