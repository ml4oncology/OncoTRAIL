...
if __name__ == "__main__":
    ...
    parser.add_argument('-s','--suffix', help="file suffix", type=str, default='') # suffix to be added to file
    args = parser.parse_args()

    mergeEmbedding(args.data_dir, args.data_file_name, args.save_dir, args.num_files, args.suffix)
